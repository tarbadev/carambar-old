...
void main() {
  ...
  testWidgets('home shows a the character informations', (WidgetTester tester) async {
    ...
    expect(characterInformationView.getCharacterSex(), displayCharacter.sex);
    expect(characterInformationView.getCharacterOrigin(), displayCharacter.origin);
    expect(characterInformationView.getCharacterAge(), displayCharacter.age);
    expect(characterInformationView.getCharacterAgeCategory(), displayCharacter.ageCategory);
  });
}
